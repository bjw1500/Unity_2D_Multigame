...
public class MapManager
{
	...
	public List<Vector3Int> CastlePoint = new List<Vector3Int>();
	public List<Vector3Int> ResourcePoint = new List<Vector3Int>();
	...
	public bool CanGo(Vector3Int cellPos)
	{
		...
		return !_collision[y, x] && (Managers.Object.Find(cellPos) ==null);
	}

	public bool CanGoForArrow(Vector3Int cellPos)
	{
		if (cellPos.x < MinX || cellPos.x > MaxX)
			return false;
		if (cellPos.y < MinY || cellPos.y > MaxY)
